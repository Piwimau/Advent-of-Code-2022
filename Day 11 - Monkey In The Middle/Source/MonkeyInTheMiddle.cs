...
namespace MonkeyInTheMiddle.Source;
...
internal sealed partial class MonkeyInTheMiddle {
    ...
    private sealed partial class Monkey {
        ...
        /// Thrown when <paramref name="divisor"/> is less than or equal to zero. Thrown as well
        /// when <paramref name="firstTarget"/> or <paramref name="secondTarget"/> is negative.
        /// </exception>
        private Monkey(
            ...
            ArgumentOutOfRangeException.ThrowIfNegative(firstTarget, nameof(firstTarget));
            ArgumentOutOfRangeException.ThrowIfNegative(secondTarget, nameof(secondTarget));
            this.items = [.. items];
        ...
        public static Monkey Parse(string s) {
            ...
            int firstTarget = int.Parse(lines[FirstTargetLine][FirstTargetStartIndex..]);
            int secondTarget = int.Parse(lines[SecondTargetLine][SecondTargetStartIndex..]);
    ...
    private static long MonkeyBusiness(
        ...
        ArgumentOutOfRangeException.ThrowIfNegative(rounds, nameof(rounds));
    ...
    internal static void Solve(TextWriter textWriter) {
        ...
        ImmutableArray<Monkey> monkeys = [.. File.ReadAllText(InputFile)
